      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              Your premier destination for professional grooming, style, and
              custom tailoring.
            </p>
            <div className="social-links">
              <a
                href="https://web.facebook.com/richy.saifar"
                aria-label="Facebook"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/ogarrichy123"
