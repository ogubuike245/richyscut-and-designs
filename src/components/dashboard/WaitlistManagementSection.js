...
import WaitlistCustomerItem from "./WaitlistCustomerItem";
...
const WaitlistManagementSection = ({
  currentQueue,
  bookingOperations,
  isLoading = false,
}) => {
  const { handleSetActive, handleServeCustomer, handleDeleteBooking } =
    bookingOperations;
...
export default WaitlistManagementSection;
