...
const Test = () => {
  return (
    <div className="test-page">
          ...
          <div className="test-hero-content">
            <div className="test-hero-left">
              ...
              <div className="test-hero-buttons">
                <a href="/queue" className="test-btn-primary">
                  BOOK APPOINTMENT
                </a>
                <a href="/gallery" className="test-btn-secondary">
                  VIEW GALLERY
                </a>
              </div>
            </div>
      ...
      {/* Experience Section */}
      <section className="test-experience">
        <div className="test-container">
          <div className="test-experience-content">
            <div className="test-experience-left">
              <div className="test-experience-badge">
                <span className="test-badge-text">PROFESSIONAL</span>
              </div>
              ...
              <div className="test-experience-stats">
                <div className="test-stat">
                  <div className="test-stat-number">10+</div>
                  <div className="test-stat-label">YEARS EXPERIENCE</div>
                </div>
                <div className="test-stat">
                  <div className="test-stat-number">100+</div>
                  <div className="test-stat-label">HAPPY CLIENTS</div>
                </div>
              </div>
            </div>
            <div className="test-experience-right">
              <div className="test-experience-image">
      ...
      <section className="test-services">
        <div className="test-container">
          <div className="test-services-header">
            <h2>OUR SERVICES</h2>
            <p>
              Nulla sagittis sapien magna sed fermentum libero tristique
              consequat. Pellentesque habitant morbi tristique senectus et netus
              et malesuada fames ac turpis egestas. Mauris dignissim at elit vel
              cursus. Mauris at magna ut mauris ut magna ut mauris.
            </p>
          </div>
          <div className="test-services-grid">
            <div className="test-service-card">
              <div className="test-service-icon">
              ...
              <div className="test-price">₦ 2,000</div>
            </div>
            <div className="test-service-card">
              <div className="test-service-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
              ...
              <div className="test-price">₦ 1,500</div>
            </div>
            <div className="test-service-card">
              <div className="test-service-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
              ...
              <div className="test-price">₦ 1,000</div>
            </div>
            <div className="test-service-card">
              <div className="test-service-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
              ...
              <div className="test-price">₦ 25,000</div>
            </div>
            <div className="test-service-card">
              <div className="test-service-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
              ...
              <div className="test-price">₦ 15,000</div>
            </div>
            <div className="test-service-card">
              <div className="test-service-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
              ...
              <div className="test-price">₦ 5,000</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="test-why-choose">
        <div className="test-container">
          <div className="test-why-choose-header">
            <h2>WHY CHOOSE US</h2>
            <p>
          ...
          <div className="test-why-choose-grid">
            <div className="test-why-choose-item">
              <div className="test-why-choose-icon">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                  <path
      ...
      <section className="test-gallery">
        <div className="test-container">
          <div className="test-gallery-header">
            <div className="test-gallery-title">
              <h2>PHOTO GALLERY</h2>
              <p>
            ...
            <div className="test-gallery-button">
              <a href="/gallery" className="test-btn-explore">
                VIEW MORE →
              </a>
            </div>
          </div>
          <div className="test-gallery-grid">
            <div className="test-gallery-item">
